...
public class RefuseState extends State {
    ...
    public ActivityInfoResult open(String activityId, Enum<Status> currentStatus) {
        return new ActivityInfoResult("0001", "审核拒绝不可开启");
    }
}
